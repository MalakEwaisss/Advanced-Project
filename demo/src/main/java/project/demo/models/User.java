...
public class User {
    ...
    private String role; // 'student' or 'organization'
    ...
    public User(String organizationName, String email, String password, String role) {
    ...
    // Constructor for login use (simple)
